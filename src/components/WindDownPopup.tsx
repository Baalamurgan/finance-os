 ...
 */
export function WindDownPopup({ daysUntil, q }: { daysUntil: number; q: string }) {
      ...
      >
        <div className="px-6 pt-6 text-center">
          ...
          <p className="mt-1.5 text-sm leading-relaxed text-slate-500">
            Log any pending spends before the month closes, then wind it down to move leftovers to
            Piggy and carry the balance forward.
          </p>
        </div>
