...
export async function generateMonth(
  ...
  for (const cat of cats) {
    ...
    // Planned-misc spend cards are one-off (they live only in the month they were created) unless they
    // repeat: repeatMonthly → re-seed EVERY month (a recurring variable budget); repeatYearly → re-seed
